...
@section('main-content')
    ...
    @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input id="thumbnail" class="form-control" type="file" name="photo2"
                            value="{{ $product->photo2 }}" multiple>
                    </div>
                    <div id="holder" style="margin-top: 15px; max-height: 100px;">
                        @if ($product->photo2)
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input id="thumbnail" class="form-control" type="file" name="photo3"
                            value="{{ $product->photo3 }}" multiple>
                    </div>
                    <div id="holder" style="margin-top: 15px; max-height: 100px;">
                        @if ($product->photo3)
