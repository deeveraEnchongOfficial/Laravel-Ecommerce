        ...
        <div class="card-body">
            <form method="post" action="{{ route('shipping.update', $shipping->id) }}">
                ...
                <div class="form-group d-none">
                    ...
                    <input id="inputTitle" type="text" name="municipality_name" placeholder="Enter Municipality Name"
                        value="{{ $shipping->municipality_name }}" class="form-control">
                    @error('title')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
                    <label for="inputTitle" class="col-form-label">Killometers Distance<span
                            class="text-danger">*</span></label>
                    <input id="inputTitle" type="number" name="distance" placeholder="Enter Distance number"
                        value="{{ $shipping->distance }}" class="form-control">
                    @error('type')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
