            ...
            {{-- {{$comment}}   --}}
              ...
              @endphp
                <tr>
                    ...
                    <td>
                        <a href="{{route('delivery_user.post-comment.edit',$comment->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                        <form method="POST" action="{{route('delivery_user.post-comment.delete',[$comment->id])}}">
                          @csrf
                          @method('delete')
