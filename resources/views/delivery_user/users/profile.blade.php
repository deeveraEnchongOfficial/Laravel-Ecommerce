        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="image">
                        @if($profile->photo)
                        <img class="card-img-top img-fluid roundend-circle mt-4" style="border-radius:50%;height:80px;width:80px;margin:auto;" src="data:image/png;base64,{{$profile->photo}}" alt="profile picture">
                        @else
                ...
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('delivery_user-profile-update',$profile->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div id="holder" style="margin-top: 15px; max-height: 100px;">
                            @if ($profile->photo)
                            <img src="{{asset($profile->photo)}}" alt="{{asset($profile->photo)}}" class="img-fluid" style="max-height: 100px;">
                            @endif
                        </div>
                        @error('photo')
                        <span class="text-danger">{{$message}}</span>
