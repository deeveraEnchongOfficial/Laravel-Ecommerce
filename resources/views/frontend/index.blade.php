...
<section id="Gslider" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item {{(($key==0)? 'active' : '')}}">
            ...
            <img class="first-slide" src="data:image/png;base64,{{$banner->photo}}" alt="First slide" style="width: 100%; height: 580px; object-fit: cover; opacity: 1;">
        ...
        <div class="row">
            ...
            <div class="carousel" id="cardCarousel">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="card">
                        @if($cat->photo)
                        <img src="{{$cat->photo}}" class="card-img-top fixed-image" alt="{{$cat->photo}}">
                        @else
                        <img src="https://via.placeholder.com/600x370" class="card-img-top fixed-image" alt="#">
                        @endif
                        <div class="card-body">
                            <h5 class="card-title">{{$cat->title}}</h5>
                            <a href="{{route('product-cat',$cat->slug)}}" class="btn btn-primary">Discover Now</a>
                        </div>
                    </div>
                </div>
...
<style>
    ...
    .fixed-image {
        ...
        object-fit: cover;
        /* Ensure the image covers the fixed height */
    }
...
<script>
    // JavaScript to implement the infinite slideshow
    const cardCarousel = document.getElementById('cardCarousel');
    let currentIndex = 0;

    function slideCards() {
        currentIndex++;
        if (currentIndex >= cardCarousel.children.length) {
            currentIndex = 0;
        }
        const translateX = -currentIndex * 320; // Adjust 320px to match card width
        cardCarousel.style.transform = `translateX(${translateX}px)`;
    }

    // Set an interval to slide the cards every 3 seconds (adjust as needed)
    setInterval(slideCards, 3000); // Change slides every 3 seconds
