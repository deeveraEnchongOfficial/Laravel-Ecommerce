                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="first_name" placeholder="" value="{{Auth()->user()->first_name}}" readonly>
                                            @error('first_name')
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="last_name" placeholder="" value="{{Auth()->user()->last_name}}" readonly>
                                            @error('last_name')
                                                <span class='text-danger'>{{$message}}</span>
                                            @enderror
                                        </div>
                                    ...
                                    @foreach(Helper::shipping() as $shipping)
                                        @php
                                            $selected = Auth()->user()->municipality_name == $shipping->id;
                                        @endphp
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="municipality" placeholder="" value="{{$shipping->municipality_name}}" readOnly>
                                                @error('municipality')
                                                    <span class='text-danger'>{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="content">
                                        <ul>
                                            ...
                                            @php
                                                ...
                                                $total_amount = $total_amount  + $shipping->price;
                                            @endphp
                                            @if(session('coupon'))
