...
<!-- End Breadcrumbs -->
<form action="{{route('shop-review.filter')}}" method="POST">
    @csrf
    <!-- Product Style 1 -->
                        ...
                        <div class="shop-shorter">
                            ...
                            <div class="single-shorter">
                                ...
                                <select class='sortBy' name='sortBy' onchange="this.form.submit();">
                                    <option value="">Star Rate</option>
                                    <option value="reviews" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='reviews' ) selected @endif>Reviews</option>
                                </select>
                            </div>
                        </div>
                        <ul class="view-mode">
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="button-head">
                                        <div class="product-action">
                                            @if (!($product->stock <= 0)) <a data-toggle="modal" data-target="#{{$product->id}}" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                @endif
                        ...
                        <div class="col-lg-8 col-md-6 col-12">
                            <div class="list-content">
                                <div class="product-content">
                                    ...
                                    @if (empty($_GET['sortBy']) && !empty($product->total_rating))
                                    <h5 class="">{{$product->total_rating}} <i class="fa fa-star text-warning"></i></h5>
                                    @endif
                                    @if (!empty($_GET['sortBy']))
                                    <h6 class="">{{$product->review_count}} Reviews </h6>
                                    @endif
                                    <!-- <h5 class="">{{$product->total_rating}} <i class="fa fa-star text-warning"></i></h5> -->
