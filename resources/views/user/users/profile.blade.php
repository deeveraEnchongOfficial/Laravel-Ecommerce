            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <form class="border px-4 pt-2 pb-3" method="POST"
                        ...
                        <div class="form-group">
                            <label for="location" class="col-form-label">Active Location</label>
                            <select name="location" class="form-control">
                                <option value="">-----Select Location-----</option>
                                @foreach ($profile->userLocation as $location)
                                <option value="{{ $location->id }}" {{ $location->status == 'active' ? 'selected' : '' }}>
                                        {{ $location->origin }}
                                    </option>
                                @endforeach
                            </select>
